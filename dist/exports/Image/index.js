...
var Image = function (_Component) {
  ...
  Image.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        other = _objectWithoutProperties(_props, ['accessibilityLabel', 'accessible', 'defaultSource', 'draggable', 'onLayout', 'source', 'testID', 'onError', 'onLoad', 'onLoadEnd', 'onLoadStart', 'resizeMode']);
